...
<body class="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat"
  style="background-image: url(/assets/img/bg-atalaya.jpg)">
  <main class="absolute top-0 left-0 bottom-0 right-0" style="backdrop-filter: blur(40px)">
    <div class="absolute top-4 md:top-16 bottom-4 md:bottom-16 left-8 md:left-32 right-8 md:right-32 bg-cover bg-center bg-no-repeat rounded-sm shadow-2xl flex items-center justify-center flex-col gap-8" style="background-image: url(/assets/img/bg-atalaya.jpg)">
